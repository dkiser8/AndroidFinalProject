 ...
 */
public class FragmentOOTargetDrag extends Fragment
{
...
//            ,tvOpenParenN1, tvOpenParenN2,tvOpenParenN3, tvOpenParenN4
//            ,tvCloseParenN1,tvCloseParenN2,tvCloseParenN3,tvCloseParenN4
            ;
//    private LinearLayout
//            llOpenParenN1, llCloseParenN1,
//            llOpenParenN2, llCloseParenN2,
//            llOpenParenN3, llCloseParenN3,
//            llOpenParenN4, llCloseParenN4;
    private int[] ia4ParenSwitcherHasViewIds = {
        R.id.tv4N1ParenA,R.id.tv4N2ParenA,R.id.tv4N3ParenA,R.id.tv4N4ParenA,
        R.id.tv4N1ParenB,R.id.tv4N2ParenB,R.id.tv4N3ParenB,R.id.tv4N4ParenB,
        R.id.LL4N1ParenA,R.id.LL4N2ParenA,R.id.LL4N3ParenA,R.id.LL4N4ParenA,
        R.id.LL4N1ParenB,R.id.LL4N2ParenB,R.id.LL4N3ParenB,R.id.LL4N4ParenB
};
...
//        return root = inflater.inflate(R.layout.fragment_fragment_ootarget_drag, container, false);
        return root = inflater.inflate(R.layout.fragment_fragment_ootarget_drag_paren, container, false);
...
//        }
    ...
    private void populateRandomValues()
    {
        ...
        tvTarget.setText("" + pjThisGame.getiTarget());
        tvResult.setText("");
...
//
    ...
    {
        //Fills numbers in array of numbers
        iaNumbers = new int[]{-1, -1, -1, -1};

        View[] vaLL = {
                root.findViewById(R.id.LinearLayoutOrderofOperationsTargetNumber1),
                root.findViewById(R.id.LinearLayoutOrderofOperationsTargetNumber2),
                root.findViewById(R.id.LinearLayoutOrderofOperationsTargetNumber3),
                root.findViewById(R.id.LinearLayoutOrderofOperationsTargetNumber4)
        };

        int[] iaN = {
                R.id.tvOOTargetDragN01,
                R.id.tvOOTargetDragN02,
                R.id.tvOOTargetDragN03,
                R.id.tvOOTargetDragN04
        };
        ...
        for(int a = 0; a < 4; a++)
        {
            for(int b = 0; b < 4; b++)
            {
                if(vaLL[a].findViewById(iaN[b]) != null)
                {
                    int iToSet;
                    switch(b)
                    {
                        case 0:
                            iToSet = pjThisGame.getnUno();
                            break;
                        case 1:
                            iToSet = pjThisGame.getnDos();
                            break;
                        case 2:
                            iToSet = pjThisGame.getnTres();
                            break;
                        case 3:
                            iToSet = pjThisGame.getnQuat();
                            break;
                        default:
                            Log.d("error", "in fill numbers");
                            return;
                    }
